...
- Normal background delivery is held for at most 30 minutes. Expiry emits a lifecycle error, fails the prompt and quarantines Pi; it is not a graceful drain or proof that detached work stopped.
